'use strict';
/*
    Add a bunch of elements, ready to be decorated with eventhandlers
    Note that some of the lines have ending semicolons while others dont, this should be handled by the minifier
*/
let  AddElementsToPage = () => {
    console.log('Start of smalltest1.js, withouth closing semicolon, should be added')

    const p1 = document.createElement('p');
    p1.innerHTML= 'I dont exist in the original HTML!';
    document.getElementById('someamazinglylongid').appendChild(p1);

    const b1 = document.createElement('button')
    b1.setAttribute('content', 'test content');
    b1.setAttribute('id', 'someamazinglylongbuttonid');  
    b1.textContent = 'Click me!';
    document.getElementsByClassName('canyoubeleivehowlongthisclassis')[0].appendChild(b1);  // select the first item in the list
}
